...
export default function PremiumMaterials({ currentChapter }: PremiumMaterialsProps) {
  return (
    <div className={`absolute inset-0 w-full h-full flex items-center justify-end px-6 md:px-28 transition-all duration-[1200ms] ease-[cubic-bezier(0.16,1,0.3,1)] z-40 ${
      currentChapter === 6 ? "opacity-100 pointer-events-auto translate-x-0" : "opacity-0 pointer-events-none translate-x-12"
    }`}>
      <div className="max-w-[420px] w-full text-right flex flex-col gap-6">
        
        <div>
          <span className="text-[10px] font-bold tracking-[0.3em] text-[#c6a972] uppercase transition-all duration-[1000ms] delay-75">
            UNCOMPROMISING BUILD
          </span>
          <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-tight font-heading text-white text-shadow-cinematic mt-2">
            GRADE 5 TITANIUM.
          </h2>
          <p className="text-muted/80 text-sm font-light leading-relaxed text-shadow-cinematic mt-4">
