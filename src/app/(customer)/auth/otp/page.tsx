    ...
    <div className="bg-background min-h-screen flex items-center justify-center px-6 pt-32 pb-24">
      <div className="max-w-md w-full">
        ...
        <div className="glass p-10 rounded-[48px] border border-white/5 space-y-10">
           <div className="flex justify-between gap-2">
              {otp.map((data, index) => (
                <input
                  ...
                  type="text"
                  maxLength={1}
                  className="w-12 h-16 bg-white/5 border border-white/5 rounded-2xl text-center text-xl font-bold text-accent focus:outline-none focus:border-accent transition-colors"
                  value={data}
           ...
           <p className="text-center text-xs text-muted font-bold uppercase tracking-widest">
